...
public class ItemPlacementHelper
{
    ...
    public ItemPlacementHelper(HashSet<Vector2Int> roomFloor, HashSet<Vector2Int> roomFloorNoCorridor)
    {
        ...
        {
            int neighboursCount8Directions = graph.GetNeighbours8Directions(position).Count;
            PlacementType type = neighboursCount8Directions < 8 ? PlacementType.NearWall : PlacementType.OpenSpace;
